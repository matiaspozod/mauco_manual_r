...
Este manual tiene como finalidad ser una guía básica del uso del ambiente Rstudio cloud para poder gestionar, manipular, transformar, analizar y visualizar un `dataset` a los interesados que han solicitado datos pertenecientes a la *Cohorte MAUCO*.
...
## Base de datos en archivo con extensión .RData

## Base de datos en archivo con extensión .csv

## Base de datos en archivo con extensión .xlsx
