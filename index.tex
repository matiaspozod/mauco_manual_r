...
\subsection{\texorpdfstring{\textbf{Barra de
tareas.}}{Barra de tareas.}}\label{barra-de-tareas.}
...
\subsection{\texorpdfstring{\textbf{Editor de
scripts.}}{Editor de scripts.}}\label{editor-de-scripts.}
...
\subsection{\texorpdfstring{\textbf{Ambiente e
historial.}}{Ambiente e historial.}}\label{ambiente-e-historial.}
...
\subsection{\texorpdfstring{\textbf{Consola.}}{Consola.}}\label{consola.}
...
\subsection{\texorpdfstring{\textbf{Archivos y
gráficos.}}{Archivos y gráficos.}}\label{archivos-y-gruxe1ficos.}
...
\subsection{\texorpdfstring{\textbf{Base de datos en archivo con
extensión
